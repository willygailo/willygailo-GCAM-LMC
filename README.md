...
| 📄 [`Tecno_Infinix_Super_Color.xml`](configs/Tecno_Infinix_Super_Color.xml) | **Super Color / Punchy**: Extra vibrant colors, rich saturation, punchy contrast, and HDR pop for social media-ready pictures. | ⬇️ **[Download XML](https://github.com/willygailo/willygailo-GCAM-LMC/releases/download/v8.5.0/Tecno_Infinix_Super_Color.xml)** |
