...
.method public constructor <init>(Llzi;Llzh;Lhwx;Lden;)V
    ...
    invoke-static {}, LMC/hsld;->setHDRregion()F
    ...
    invoke-static {}, LMC/hsld;->setZSLFrames()I
    ...
    invoke-static {}, LMC/hsld;->setAEautomax()F
    ...
    if-eqz v4, :cond_transsion_not

    invoke-static {v0, v0}, Lcom/Transsion;->overrideDefaults(Lddj;Lddf;)V

    goto/16 :goto_6

    :cond_transsion_not
    invoke-static {}, LMC/Device;->isRedmiNote8()Z
    ...
    :cond_1a
    invoke-static {}, LMC/Device;->isnokia()Z
    ...
    :cond_1b
    invoke-static {}, LMC/Device;->isOnePlus()Z
    ...
    :cond_1c
    invoke-static {}, LMC/Device;->OppoVivoRealme()Z
    ...
    :cond_1d
    invoke-static {}, LMC/Device;->isOnePlus9()Z
    ...
    :cond_1e
    invoke-static {}, LMC/Device;->isOnePlus7()Z
    ...
    :cond_20
    invoke-static {}, LMC/Device;->Fog()Z
    ...
    invoke-static {v0, v0}, Lcom/Samsungs23U;->overrideDefaults(Lddj;Lddf;)V

    goto/16 :goto_6

    :cond_23
    invoke-static {}, LMC/Device;->Samsungs22USnapdragon()Z
    ...
    :cond_25
    invoke-static {}, LMC/Device;->M52()Z
    ...
    :cond_26
    invoke-static {}, LMC/Device;->Random()Z
    ...
    :cond_28
    invoke-static {}, LMC/Device;->isStar()Z
    ...
    :cond_29
    invoke-static {}, LMC/Device;->is12tpro()Z
    ...
    :cond_2a
    invoke-static {}, LMC/Device;->isRealme9()Z
    ...
    :cond_2b
    invoke-static {}, LMC/Device;->isRN8P()Z
    ...
    :cond_2c
    invoke-static {}, LMC/Device;->VivoDevice()Z

    move-result v4

    if-eqz v4, :cond_2d

    invoke-static {v0, v0}, Lcom/VIVO;->overrideDefaults(Lddj;Lddf;)V

    goto/16 :goto_6

    :cond_2d
    invoke-static {}, LMC/Device;->Mi10TPro()Z
    ...
    invoke-static {v0, v0}, Lcom/Samsungs22Exynos;->overrideDefaults(Lddj;Lddf;)V
    ...
    invoke-static {v0}, LMC/hsld;->setDeveloperSettings(Ldep;)V
