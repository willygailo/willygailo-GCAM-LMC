...
public class TF extends ToggleButton {
    ...
    public TF(Context context) {
        super(context);
        this.myChangeListner = new CompoundButton.OnCheckedChangeListener() { // from class: MC.UI.Button.TF.1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                int i = (TF.SelState + 1) % 2;
                TF.SelState = i;
                Pref.setValue("pref_track_focus_key", i);
                Context context2 = compoundButton.getContext();
                hslh.HapticFeedback(context2);
                TF.this.UpdateUi(context2);
            }
        };
        this.myClickListener = new View.OnClickListener() { // from class: MC.UI.Button.TF.2
    ...
    public TF(Context context, AttributeSet attributeSet, int i) {
        ...
        this.myChangeListner = new CompoundButton.OnCheckedChangeListener() { // from class: MC.UI.Button.TF.1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                int i2 = (TF.SelState + 1) % 2;
                TF.SelState = i2;
                Pref.setValue("pref_track_focus_key", i2);
                Context context2 = compoundButton.getContext();
                hslh.HapticFeedback(context2);
                TF.this.UpdateUi(context2);
            }
    ...
    public TF(Context context, AttributeSet attributeSet, int i, int i2) {
        ...
        this.myChangeListner = new CompoundButton.OnCheckedChangeListener() { // from class: MC.UI.Button.TF.1
            @Override // android.widget.CompoundButton.OnCheckedChangeListener
            public void onCheckedChanged(CompoundButton compoundButton, boolean z) {
                int i3 = (TF.SelState + 1) % 2;
                TF.SelState = i3;
                Pref.setValue("pref_track_focus_key", i3);
                Context context2 = compoundButton.getContext();
                hslh.HapticFeedback(context2);
                TF.this.UpdateUi(context2);
            }
    ...
    public void getVisibility() {
        if (Pref.MenuValue("pref_show_button_tf") == 0) {
            setVisibility(8);
        }
    }
    ...
    public void init(Context context) {
        ...
        SelState = Pref.MenuValue("pref_track_focus_key");
        getVisibility();
        UpdateUi(context);
