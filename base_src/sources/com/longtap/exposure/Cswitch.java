...
/* JADX INFO: renamed from: com.longtap.exposure.switch, reason: invalid class name */
...
public class Cswitch {
    ...
    public static void setLongClickListener(View view, Context context) {
        view.setOnLongClickListener(new View.OnLongClickListener(context) { // from class: com.longtap.exposure.switch.1
            ...
            public boolean onLongClick(View view2) {
                ...
                if (Helper.sFront != 0) {
                    title = builder.setTitle("Exposure time");
                    keyValue = getKeyValue("pref_aemode_back_key");
                    onClickListener = new DialogInterface.OnClickListener(context2) { // from class: com.longtap.exposure.switch.2
                        private final Context this$0;
