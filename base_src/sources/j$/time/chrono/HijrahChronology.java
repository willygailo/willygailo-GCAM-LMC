...
public final class HijrahChronology extends AbstractChronology implements Serializable {
    ...
    private void loadCalendarData() {
        try {
            ...
            String strValueOf = String.valueOf(this.typeId);
            throw new DateTimeException(strValueOf.length() != 0 ? "Unable to initialize HijrahCalendar: ".concat(strValueOf) : new String("Unable to initialize HijrahCalendar: "), e);
        }
    }
