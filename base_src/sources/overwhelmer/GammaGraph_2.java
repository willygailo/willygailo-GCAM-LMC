...
public class GammaGraph_2 extends GraphView {
    ...
    /* JADX WARN: Type inference failed for: r3v6, types: [overwhelmer.GammaGraph, overwhelmer.GammaGraph_2] */
    /* JADX WARN: Unreachable blocks removed: 2, instructions: 8 */
    public static void drawGamma() {
        getGammaCurve.gammaPresetName_2 = "Default";
        _GammaGraph = getGammaCurve.getGammaCurve(2);
        ...
        ArrayLogPointDouble(pointArr, "addlogsdir/_GammaGraphPoint_2.log");
    }
