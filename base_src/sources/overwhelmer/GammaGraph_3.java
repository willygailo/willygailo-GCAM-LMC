...
public class GammaGraph_3 extends GraphView {
    ...
    /* JADX WARN: Type inference failed for: r3v6, types: [overwhelmer.GammaGraph, overwhelmer.GammaGraph_3] */
    /* JADX WARN: Unreachable blocks removed: 2, instructions: 8 */
    public static void drawGamma() {
        getGammaCurve.gammaPresetName_3 = "Default";
        _GammaGraph = getGammaCurve.getGammaCurve(3);
        ...
        ArrayLogPointDouble(pointArr, "addlogsdir/_GammaGraphPoint_3.log");
    }
