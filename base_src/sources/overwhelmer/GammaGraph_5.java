...
public class GammaGraph_5 extends GraphView {
    ...
    /* JADX WARN: Type inference failed for: r3v6, types: [overwhelmer.GammaGraph, overwhelmer.GammaGraph_5] */
    /* JADX WARN: Unreachable blocks removed: 2, instructions: 8 */
    public static void drawGamma() {
        getGammaCurve.gammaPresetName_5 = "Default";
        _GammaGraph = getGammaCurve.getGammaCurve(5);
        ...
        ArrayLogPointDouble(pointArr, "addlogsdir/_GammaGraphPoint_5.log");
    }
