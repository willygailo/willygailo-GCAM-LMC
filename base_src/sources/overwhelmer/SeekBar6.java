...
public class SeekBar6 extends Preference implements SeekBar.OnSeekBarChangeListener {
    ...
    public SeekBar6(Context context, AttributeSet attributeSet, int i) {
        ...
        this.max = 16;
        this.step = 1;
        setLayoutResource(2131624196);
    }

    public static int men2prog(int i) {
        return i / R.styleable.AppCompatTheme_windowMinWidthMinor;
    }
    ...
    protected void onBindView(View view) {
        ...
        this.mSeekBar = (SeekBar) view.findViewById(com.google.android.GoogleCameraEngR18F1.R.id.dummy_386);
        this.mSeekBar.setMax((this.max - this.min) / this.step);
        this.mSeekBar.setProgress(this.mProgress);
        this.mSeekBar.setOnSeekBarChangeListener(this);
        this.mTextView = (TextView) view.findViewById(com.google.android.GoogleCameraEngR18F1.R.id.dummy_385);
